    ...
    <>
      <div className="p-[10px] md:p-[70px] flex md:flex-row flex-col gap-[30px] md:items-start items-center">
        <div className="flex flex-col gap-8 items-center md:items-start w-full md:w-[60%]">
          <h1 className="md:text-5xl text-2xl text-center md:text-left font-bold">
            Why join Terafort?
          </h1>
          <p className="md:text-[26px] text-[18px] text-center md:text-left font-medium text-orange-400 md:font-bold">
            Entrepreneurs, Intrapreneurs, Tech Lovers & Freethinkers… you’ve
            come to the Right Place!
          </p>

          {/* why join it */}
          <p className="md:text-xl text-[15px] text-center md:text-left font-normal md:font-medium mt-4">
        ...
        <div className="md:w-[30%] w-full">
          <img src="images/join.webp" alt="" className="rounded-md" />
        </div>
      </div>
    </>
  );
